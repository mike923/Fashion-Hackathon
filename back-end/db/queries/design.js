...
const addNewDesign = async (design) => await db.one(`
    INSERT INTO product_design(design_file, designer_specs, designer_id, manufacturer_id,product_name)
	VALUES($/design_file/, $/designer_specs/, $/designer_id/, $/manufacturer_id/,$/product_name/)
	RETURNING *
`, design)
